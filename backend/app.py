...
from backend.agents import a01_reflection, a02_tool_use  # noqa: E402
from backend.agents import a09_tree_of_thoughts  # noqa: E402
from backend.agents import a05_pev  # noqa: E402
from backend.agents import a06_blackboard  # noqa: E402
from backend.agents import a08_graph_memory  # noqa: E402
from backend.agents import a10_ensemble_decision  # noqa: E402
from backend.agents import a11_meta_controller  # noqa: E402
from backend.agents import a12_self_ask  # noqa: E402
from backend.agents import a13_chain_of_verification  # noqa: E402
from backend.agents import a14_dry_run  # noqa: E402
from backend.agents import a15_rlhf_loop  # noqa: E402
from backend.agents import a16_simulator_mitl  # noqa: E402
from backend.agents import a17_reflexive_metacognitive  # noqa: E402
from backend.core.rag import retriever  # noqa: E402
from backend.core.llm import make_llm  # noqa: E402
from backend.core.patterns_data import PATTERNS  # noqa: E402
from backend.core.schemas import (  # noqa: E402
    PatternListOut,
    PatternMeta,
    PatternExecIn,
...
def execute_pattern(pid: str, body: PatternExecIn):
    ...
    if pid == "tool_use":
        ...
        state = {
            "question": body.input.get(
                "question",
                "Quelles ont été les annonces majeures de la dernière WWDC ?",
            ),
            "hits": [],
            "sources": [],
            "answer": "",
    ...
    if pid == "reflection":
        ...
        state = {
            "prompt": body.input.get(
                "prompt", "Explique la loi des grands nombres simplement."
            ),
...
def set_provider_config(
    llm: dict = Body(default={}), embeddings: dict = Body(default={})
):
